...
from backend.api.utils import is_valid_password
...
async def add_user(
    ...
    try:
        user = user_service.create_user(name,cpf,email, password)
...
async def update_user(
    ...
    try: 
        updated_user = user_service.update(id, cpf, email, password)
